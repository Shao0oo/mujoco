...
execute_process(
  COMMAND "/opt/homebrew/bin/git" --git-dir=.git show-ref "7482de6071d21db77a7236155da44c172a7f6c9e"
  WORKING_DIRECTORY "/Users/alexshao/Desktop/mujoco/cmake-build-debug/_deps/glfw3-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/alexshao/Desktop/mujoco/cmake-build-debug/_deps/glfw3-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/alexshao/Desktop/mujoco/cmake-build-debug/_deps/glfw3-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
