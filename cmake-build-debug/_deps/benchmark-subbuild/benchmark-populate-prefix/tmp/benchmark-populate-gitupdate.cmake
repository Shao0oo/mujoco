...
execute_process(
  COMMAND "/opt/homebrew/bin/git" --git-dir=.git show-ref "049f6e79cc3e8636cec21bbd94ed185b4a5f2653"
  WORKING_DIRECTORY "/Users/alexshao/Desktop/mujoco/cmake-build-debug/_deps/benchmark-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/alexshao/Desktop/mujoco/cmake-build-debug/_deps/benchmark-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/alexshao/Desktop/mujoco/cmake-build-debug/_deps/benchmark-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
