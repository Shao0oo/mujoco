...
execute_process(
  COMMAND "/opt/homebrew/bin/git" --git-dir=.git show-ref "f03a1b3ec29b1d7d865691ca8aea4f1eb2c2873d"
  WORKING_DIRECTORY "/Users/alexshao/Desktop/mujoco/cmake-build-debug/_deps/marchingcubecpp-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/alexshao/Desktop/mujoco/cmake-build-debug/_deps/marchingcubecpp-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/alexshao/Desktop/mujoco/cmake-build-debug/_deps/marchingcubecpp-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
